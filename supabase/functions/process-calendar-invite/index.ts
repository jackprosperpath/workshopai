      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <h2 style="color: #4F46E5;">Your Workshop Has Been Created</h2>
            <p>Thank you for using Teho AI to organize your workshop!</p>
            <p>We've processed your calendar invite for <strong>${summary}</strong> on ${formattedDate}.</p>
            
            <div style="background-color: #F3F4F6; padding: 15px; border-radius: 8px; margin: 20px 0;">
              <p style="margin: 0; font-size: 16px;">
                <strong>Workshop Preview:</strong><br>
            ...
            <p>You can customize your workshop agenda, invite team members, and generate AI-powered facilitation materials.</p>
            
            <p style="color: #6B7280; font-size: 14px; margin-top: 30px;">
              This email was automatically generated by Teho AI.<br>
              If you didn't create this workshop, you can safely ignore this message.
            </p>
          </div>
        `,
      });
