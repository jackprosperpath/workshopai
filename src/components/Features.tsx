...
const featureDecor = [
  { color: postItColors[0], rotate: -4 },
  { color: postItColors[1], rotate: 3 },
  { color: postItColors[2], rotate: 6 },
  { color: postItColors[4], rotate: -7 },
];
              ...
              return (
                <Card
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0px 6px 24px 0px rgba(31, 41, 55, 0.09), 0 1.5px 0 0 rgba(143, 143, 143, 0.01)",
                  }}
                >
